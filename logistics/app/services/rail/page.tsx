        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="mb-8">
            <ol className="flex items-center gap-2 text-sm text-gray-400">
              ...
              <li>/</li>
              <li className="text-white">Rail Freight</li>
            </ol>
          </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Optimal balance between speed and cost. Regular train departures with reliable transit times.
              </p>
              <div className="flex flex-wrap gap-4">
                <Link href="/request?service=rail" className="btn-primary">
                  Get Quote
                </Link>
                <Link href="/calculator?service=rail" className="btn-outline border-white text-white hover:bg-white hover:text-[#1B3B6F]">
                  Calculate Cost
                </Link>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-[#1B3B6F]">15-20</div>
              <div className="text-[#1B3B6F]/80 font-medium">Days Delivery</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-[#1B3B6F]">$4</div>
              <div className="text-[#1B3B6F]/80 font-medium">Per kg from</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-[#1B3B6F]">Weekly</div>
              <div className="text-[#1B3B6F]/80 font-medium">Departures</div>
            </div>
            <div className="text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <h2 className="text-3xl font-bold text-[#1B3B6F] mb-6">About Rail Freight Service</h2>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Rail freight offers an excellent balance between the speed of air cargo and the economy of sea freight. Our rail services connect Russia to Vietnam through established trans-continental routes.
              </p>
              <p className="text-gray-600 mb-8 leading-relaxed">
                With regular departures and fixed schedules, rail freight provides predictable transit times and competitive pricing for medium to large shipments.
              </p>
              ...
              <h3 className="text-2xl font-bold text-[#1B3B6F] mb-4">Routes</h3>
              <div className="grid md:grid-cols-2 gap-4 mb-8">
                {[
                  { route: 'Moscow - Hanoi', time: '15-18 days' },
                  { route: 'Moscow - Ho Chi Minh', time: '18-20 days' },
                  { route: 'Vladivostok - Vietnam', time: '12-15 days' },
                  { route: 'St. Petersburg - Vietnam', time: '20-25 days' },
                ].map((item, i) => (
                  <div key={i} className="p-4 border border-gray-200 hover:border-[#E5A835] transition-colors">
                    <h4 className="font-bold text-[#1B3B6F] mb-1">{item.route}</h4>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-[#1B3B6F] p-8 mb-8">
                ...
                <Link href="/request?service=rail" className="btn-primary w-full text-center block">
                  Request Quote
                </Link>
              </div>
      ...
      <section className="py-16 bg-[#E5A835]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-[#1B3B6F]/80 text-lg mb-8">
            Contact us today for a free quote and let us handle your rail freight needs
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/request?service=rail" className="btn-secondary">
              Get Started
            </Link>
